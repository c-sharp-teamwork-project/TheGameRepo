    ...
    static void Main()
    {
        ...
        while (true)
        {
            ...
            for (int i = 0; i < objects.Count; i++)
            {
                ...
                if (newObject.y + 1 <= Console.WindowHeight)
                {
            ...
            PrintStringOnPosition(8, 4, "Lives count: " + livesCount, ConsoleColor.White);
            PrintStringOnPosition(8, 5, "Speed-o-meter: " + speed, ConsoleColor.White);
            PrintStringOnPosition(8, 6, "Throttle " + acceleration, ConsoleColor.White);
